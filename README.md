...
Contenido del repositorio:
  ...
  3. Directorio Mapas: Contiene los mapas de análisis de las variables, los mapas de evolución de las mismas y los mapas resultantes de aplicar el análisis principal de componentes y los disntitos métodos de machine learning.
